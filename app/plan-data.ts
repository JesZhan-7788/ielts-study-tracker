...
const daySources: DaySource[] = [
  ...
  { week: 2, content: "听力: Section 1+2 整套；听力: 本周生词／连读复盘", materials: "剑15-19；王陆语料库", duration: "~2h" },
  { week: 2, content: "写作: 教育类词伙首轮产出；基础: 定语从句关系代词专项", materials: "顾家北词伙2.0；顾家北写作语法知识", duration: "~1.5h" },
  { week: 2, content: "阅读: TFNG 限时专项；口语: Part 1：你怎么看类 × 教育话题", materials: "剑15-19；雅思主题阅读法；十天突破雅思口语", duration: "~1.5h" },
  { week: 2, content: "基础: 周复盘①（Day 6–10）+ 遗留清算；口语: Part 3：原因类 + 方法类论证句式", materials: "Weekly-Reviews；十天突破雅思口语", duration: "~1h" },
  { week: 3, content: "写作: 完整 Task 2 #2（环境类）。写作前：精读顾家北 2.2.11 思考观点、2.2.12 开头段和附录 1 观点角度，查阅急救短语环境类搭配，参考观点库环境类论点。写作后：自主分轮校对一遍再发我批改，批改后更新写作错题本；基础: 固定搭配专项 1", materials: "顾家北手把手教你雅思写作（2.2.11／2.2.12／附录1）；慎小嶷急救短语和速查短语；慎小嶷议论文观点库；顾家北写作语法知识", duration: "~2.5h" },
  { week: 3, content: "阅读: 阅读整套模考 #2（独占）", materials: "剑15-19", duration: "~2.5h" },
  { week: 3, content: "口语: Part 2：家乡话题；口语: Part 1：为什么类 × 工作话题", materials: "十天突破雅思口语；Jes档案", duration: "~1.5h" },
  { week: 3, content: "写作: 城市化类词伙首轮产出；基础: 中式英语常见误区专项", materials: "顾家北词伙2.0；顾家北写作语法知识", duration: "~1.5h" },
  { week: 3, content: "听力: Section 3 专项；听力: 场景听写（教育／健康任选 1）", materials: "剑15-19；王陆语料库", duration: "~1.5h" },
  ...
  { week: 4, content: "口语: Part 2：物品类 Jes 素材开发；口语: Part 1：童年类话题迁移", materials: "十天突破雅思口语；Jes档案", duration: "~1.5h" },
  { week: 4, content: "阅读: 施正南法精读（独立分支）；写作: 生活方式类词伙首轮产出（替换原“科技第二轮巩固”，优先补新话题）", materials: "雅思主题阅读法；顾家北词伙2.0", duration: "~1.5h" },
  { week: 4, content: "听力: Section 1+2 整套 #2；听力: 生词／连读复盘", materials: "剑15-19；王陆语料库", duration: "~2h" },
  { week: 4, content: "基础: 周复盘③（Day 17–21）；口语: Part 3：展望未来类论证句式", materials: "Weekly-Reviews；十天突破雅思口语", duration: "~1h" },
  { week: 5, content: "写作: 完整 Task 2 #4（自选话题，限时）。写作前：精读顾家北 2.2.17 换词、2.2.21 标点与常见语法错误和附录 6／7／9（冠词单复数／词性／句子结构错误）。写作后：自主分轮校对并更新错题本；基础: 综合自查清单（个人定制版，非通用版）", materials: "顾家北手把手教你雅思写作（2.2.17／2.2.21／附录6／7／9）；顾家北写作语法知识", duration: "~2.5h" },
  { week: 5, content: "阅读: 阅读整套模考 #3（独占）", materials: "剑15-19", duration: "~2.5h" },
  { week: 5, content: "口语: 话题稿朗读 ×2（家乡 + 健康）；口语: Part 1：剩余题型查漏补缺", materials: "十天突破雅思口语", duration: "~1.5h" },
  { week: 5, content: "写作: 工作类词伙首轮产出；基础: 错题本全面复盘", materials: "顾家北词伙2.0；顾家北写作语法知识", duration: "~1.5h" },
  { week: 5, content: "基础: 周复盘④（Day 23–26）；口语: Jes 档案：补全建筑设施 + 物品类三层表达库", materials: "Weekly-Reviews；Jes档案", duration: "~1h" },
  { week: 6, content: "写作: 政府类词伙首轮产出（新增，补覆盖率）；基础: 写作错题本高频类型专项复习", materials: "顾家北词伙2.0；写作错题本", duration: "~1.5h" },
  ...
  { week: 6, content: "写作: 环境类词伙首轮产出（新增，补覆盖率）；口语: Part 1：爱好类补漏", materials: "顾家北词伙2.0；十天突破雅思口语", duration: "~1.5h" },
  { week: 6, content: "基础: 阶段一综合复盘：汇总四项材料 + 口语 matrix 覆盖度 + 写作错题本高频类型，确定阶段二重点", materials: "Weekly-Reviews；Dashboard；写作错题本", duration: "~1.5–2h" },
];
